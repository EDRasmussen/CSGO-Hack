#pragma once
// All structs except Vector3 are from https://developer.valvesoftware.com/wiki/Source_BSP_File_Format
#include <Windows.h>
#include "CSMath.h"
...
public:
    ...
    dnode_t* GetNodeLump() const;
    dplane_t* GetPlaneLump() const;
    dleaf_t* GetLeafLump() const;
    dleaf_t* GetLeafFromPoint(Vector3 point);
